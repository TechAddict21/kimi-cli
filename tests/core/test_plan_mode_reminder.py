...
def test_detects_sparse_reminder_with_path() -> None:
    msg = _user_msg(
        f"<system-reminder>\n{_sparse_reminder('/home/user/.pc-kimi/plans/iron-man.md')}\n</system-reminder>"
    )
    assert _has_plan_reminder(msg)
...
def test_detects_full_reminder_with_path() -> None:
    msg = _user_msg(
        f"<system-reminder>\n{_full_reminder('/home/user/.pc-kimi/plans/iron-man.md')}\n</system-reminder>"
    )
    assert _has_plan_reminder(msg)
...
def test_detects_full_reminder_with_existing_plan() -> None:
    msg = _user_msg(
        f"<system-reminder>\n{_full_reminder('/home/user/.pc-kimi/plans/batman.md', plan_exists=True)}\n</system-reminder>"
    )
    assert _has_plan_reminder(msg)
...
def test_detection_stays_in_sync_with_reminder_text() -> None:
    ...
    """
    for path in [None, "/tmp/plan.md", "/home/user/.pc-kimi/plans/batman.md"]:
